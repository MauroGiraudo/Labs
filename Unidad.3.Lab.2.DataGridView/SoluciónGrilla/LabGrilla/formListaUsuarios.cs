...
namespace LabGrilla
{
    public partial class formListaUsuarios : Form
    {
        ...
        private void GenerarColumnas()
        {
            ...
            colTel.Name = "email";
            colTel.HeaderText = "E-mail";
            colTel.DataPropertyName = "email";
            colTel.DisplayIndex = 0;
            
            DataGridViewTextBoxColumn colCel = new DataGridViewTextBoxColumn();
            colTel.Name = "cel";
            colTel.HeaderText = "Celular";
            colTel.DataPropertyName = "cel";
            colTel.DisplayIndex = 0;
            
            DataGridViewTextBoxColumn colUsuario = new DataGridViewTextBoxColumn();
            colTel.Name = "usuario";
            colTel.HeaderText = "Usuario";
            colTel.DataPropertyName = "usuario";
            colTel.DisplayIndex = 0;
            
            DataGridViewTextBoxColumn colClave = new DataGridViewTextBoxColumn();
            colTel.Name = "clave";
            colTel.HeaderText = "Clave";
            colTel.DataPropertyName = "clave";
            colTel.DisplayIndex = 0;
